...
public class TambahTeman extends AppCompatActivity {
    ...
    private static String url_insert = "https://20200140086.praktikumtiumy.com/tambahtm.php";
    ...
    public void SimpanData()
    {
        ...
        Intent i = new Intent(TambahTeman.this, com.example.activity8.MainActivity.class);
        startActivity(i);
        finish();
    }
}